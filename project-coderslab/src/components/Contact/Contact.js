    ...
    return (
        ...
        <form onSubmit ={handleSubmit}>
            ...
            <div>
                ...
                <input id="name" type="text" value={name} placeholder={"Imię"} required onChange={(e) => setName(e.target.value)}></input>
            </div>
            <div>
                <label htmlFor="surname">Nazwisko</label>
                <input id="surname" type="text" value={surname} placeholder={"Nazwisko"} required onChange={(e) => setSurname(e.target.value)}></input>
            </div>
            <div>
                <label htmlFor="company">Nazwa firmy</label>
                <input id="company" value={company} placeholder={"Nazwa firmy"} onChange={(e) => setCompany(e.target.value)}></input>
            </div>
            <div>
                <label htmlFor="email">E-mail</label>
                <input id="email" type="email" value={email}  placeholder={"twoj@email.pl"} required onChange={(e) => setEmail(e.target.value)}></input>
            </div>
            <div>
                <label htmlFor="message-title">Temat wiadomości</label>
                <input id="message-title" placeholder={"Temat wiadomości"} value={messageTitle} onChange={(e) => setMessageTitle(e.target.value)}></input>
            </div>
            <div>
                <label htmlFor="message">Treść wiadomości</label>
                <textarea id="message"  value={message} placeholder={"Tu wpisz treść wiadomości"} onChange={(e) => setMessage(e.target.value)}></textarea>
            </div>
